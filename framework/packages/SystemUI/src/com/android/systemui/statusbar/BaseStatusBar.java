...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    public static final boolean DEBUG = true;//Log.isLoggable(TAG, Log.DEBUG);	//LSP
...
// LSP start
    private void sendLSP(String message) {
        Intent intent = new Intent("kr.ac.snu.lsprofiler.intent.action.STATUSBAR");
...
// LSP end
    ...
    private RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() {
        ...
        public boolean onClickHandler(
	       ...
	       //Log.v("LSP", "Notification click handler invoked for intent: " + pendingIntent);
            logActionClick(view);
    ...
    private boolean inflateViews(NotificationData.Entry entry, ViewGroup parent, boolean isHeadsUp) {
	   ...
	   //Log.v("LSP", "publicNotification: " + sbn.getNotification().publicVersion);
...
// LSP start
            //Log.d("LSP", "Clicked on content of " + mNotificationKey);
            sendLSP("onClick " + mNotificationKey);
// LSP end
            final boolean keyguardShowing = mStatusBarKeyguardViewManager.isShowing();
    ...
    protected NotificationData.Entry createNotificationViews(StatusBarNotification sbn) {
	   ...
	   //Log.d("LSP", "createNotificationViews(notification=" + sbn);
        // Construct the icon.
        Notification n = sbn.getNotification();
