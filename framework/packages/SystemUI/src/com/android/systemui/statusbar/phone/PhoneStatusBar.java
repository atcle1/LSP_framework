...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    public static final boolean SPEW = false;	//LSP
...
Log.d("LSP", "MSG_OPEN_NOTIICATION_PANEL");
                    animateExpandNotificationsPanel();
                    break;
                case MSG_OPEN_SETTINGS_PANEL:
Log.d("LSP", "MSG_OPEN_SETTINGS_PANEL");
                    animateExpandSettingsPanel();
                    break;
                case MSG_CLOSE_PANELS:
Log.d("LSP", "MSG_CLOSE_PANEL");
                    animateCollapsePanels();
                    break;
                case MSG_SHOW_HEADS_UP:
Log.d("LSP", "MSG_SHOW_HEADS_UP");
                    setHeadsUpVisibility(true);
                    break;
                case MSG_DECAY_HEADS_UP:
Log.d("LSP", "MSG_DECAY_HEADS_UP");
                    mHeadsUpNotificationView.release();
                    setHeadsUpVisibility(false);
                    break;
                case MSG_HIDE_HEADS_UP:
Log.d("LSP", "MSG_HIDE_HEADS_UP");
                    mHeadsUpNotificationView.release();
                    setHeadsUpVisibility(false);
                    break;
                case MSG_ESCALATE_HEADS_UP:
Log.d("LSP", "MSG_ESCALATE_HEADS_UP");
                    escalateHeadsUp();
                    setHeadsUpVisibility(false);
                    break;
                case MSG_LAUNCH_TRANSITION_TIMEOUT:
Log.d("LSP", "MSG_LAUNCH_TRANSITION_TIMEOUT");
